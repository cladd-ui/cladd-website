...
export default ({ children }) => (
  <DocsLayout
    title="Popover — Cladd"
    description="Anchored, portalled floating surface for menus, option sheets, and inline editors — built on CSS anchor positioning with auto-flip and an optional dismiss backdrop."
  >
    {children}
  </DocsLayout>
);
