...
export default ({ children }) => (
  <DocsLayout
    ...
    description="Auto-advancing one-time-code field with paste handling, configurable cell count, and optional separators — drop in for MFA prompts and magic-link confirmations."
  >
    {children}
  </DocsLayout>
);
