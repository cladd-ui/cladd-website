...
export default ({ children }) => (
  <DocsLayout
    ...
    description="Drag-to-change number control with click-to-edit fallback — the inspector-sidebar input that powers font-size, padding, opacity, and rotation in cladd apps."
  >
    {children}
  </DocsLayout>
);
