...
export default ({ children }) => (
  <DocsLayout
    ...
    description="Compact keyboard shortcut display — sizes 2xs → 2xl, automatic glyphs for cmd/shift/arrows, designed to nest inside Button, Tooltip, and ListButton."
  >
    {children}
  </DocsLayout>
);
