...
Cladd ships an official [**MCP server**](/mcp/) at `cladd.io/api/mcp`. Connect it to Claude Code, Cursor, Claude Desktop, or any MCP-capable client and your agent gets the full docs at its fingertips — every component, foundation, and hook, with code examples, props, and inline screenshot URLs so it can see what a component looks like before writing layout code.
